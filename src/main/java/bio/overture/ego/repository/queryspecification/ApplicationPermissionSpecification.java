...
public class ApplicationPermissionSpecification {
  ...
  public static Specification<ApplicationPermission> buildFilterSpecification(
      @NonNull UUID policyId, @NonNull List<SearchFilter> filters) {
    return buildFilterAndQuerySpecification(policyId, filters, null);
  }

  public static Specification<ApplicationPermission> buildFilterAndQuerySpecification(
    ...
    return (root, query, builder) -> {
      ...
      val ownerSp = scb.leftJoinFetch(Application.class, OWNER);
