...
//  protected abstract void associateChildWithParents(C childWithParents, Collection<P> parents);
  protected abstract void disassociate(P parentWithChildren, Collection<UUID> childIds);
//  protected abstract void disassociateChildFromParents(C childWithParents, Collection<UUID> parentIds);

  protected abstract Collection<C> extractChildrenFromParent(P parent);
//  protected abstract Collection<P> extractParentsFromChild(C child);
  protected abstract P getParentWithChildren(UUID parentId);
//  protected abstract C getChildWithParents(UUID childId);
