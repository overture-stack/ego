...
public class ApplicationGroupAssociationService
    extends AbstractManyToManyAssociationService<Application, Group> {

  private final ApplicationService applicationService;

  public ApplicationGroupAssociationService(
      @NonNull GroupService groupService, @NonNull ApplicationService applicationService) {
  ...
  public Page<Application> findParentsForChild(FindRequest findRequest) {
    ...
    return (Page<Application>)
        applicationService.getRepository().findAll(spec, findRequest.getPageable());
  }
  ...
  public void disassociate(
      @NonNull Application application, @NonNull Collection<UUID> groupIdsToDisassociate) {
