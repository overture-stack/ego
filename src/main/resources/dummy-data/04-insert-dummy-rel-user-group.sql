...
INSERT INTO public.usergroup (username, grpname)
  SELECT u.username, g.grpname
  FROM public.egouser AS u
    LEFT JOIN public.egogroup AS g
      ON g.grpname='XYZ Cancer Research Institute'
  WHERE u.username IN ('Carmel.Corkery@example.com','Viviane.Langworth@example.com','Justice.Heller@example.com','Louvenia.Emard@example.com');
