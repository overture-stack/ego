...
INSERT INTO public.userapplication (userId, appId)
  SELECT u.id, a.id
  FROM public.egouser AS u
    LEFT JOIN public.egoapplication AS a
      ON a.name='Personal Information Manager'
  WHERE u.name IN ('Brennan.Denesik@example.com','Anika.Stehr@example.com','Janessa.Cronin@example.com','Sharon.Farrell@example.com','Zane.Rath@example.com','Elisha.Weimann@example.com');
