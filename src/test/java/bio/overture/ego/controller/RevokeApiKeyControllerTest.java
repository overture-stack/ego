...
//    entityGenerator.setupApiKey(test.adminUser, adminTokenName, false, 1000, "test token",
// scopes);
//
...
//    val apiKey =
//        entityGenerator.setupApiKey(test.adminUser, apiKeyName, false, 1000, "test token",
// scopes);
//
