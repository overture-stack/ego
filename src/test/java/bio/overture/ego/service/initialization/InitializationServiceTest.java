...
public class InitializationServiceTest {
  ...
  public void initialize_multipleApps_success() {
    ...
    assertFalse(applicationService.findByClientId2(appClientId1).isPresent());
    assertFalse(applicationService.findByClientId2(appClientId2).isPresent());
    ...
    assertTrue(applicationService.findByClientId2(appClientId1).isPresent());
    assertTrue(applicationService.findByClientId2(appClientId2).isPresent());
  }
